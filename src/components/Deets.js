  ...
  return (
    <div className="w-3/4 lg:w-1/2 mx-auto p-5 rounded-md bg-purple ring-4 ring-aqua shadow-xl shadow-ltPink flex flex-col items-center overflow-scroll">
      ...
      <div className="py-5 text-center text-ltPink text-xl">
        ...
        <a href="https://www.google.com/maps/place/Lindenstra%C3%9Fe+27,+12555+Berlin/@52.4536661,13.5652145,17z/data=!3m1!4b1!4m6!3m5!1s0x47a84866a83cb09b:0x1cd0c51d2d5f58ee!8m2!3d52.4536629!4d13.5677894!16s%2Fg%2F11crshsn42?entry=ttu" target="_blank" rel="noopener noreferrer" className="underline hover:text-mauve">Lindenstraße 27, 12555</a>
        <br/>
        <a href="https://als-bootsverleih.de/boote/18er-floss" target="_blank" rel="noopener noreferrer">Company: <span className="underline hover:text-mauve">ALS Bootsverleih</span></a>
      </div>
